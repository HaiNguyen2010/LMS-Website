...
interface TeacherClassSubjectsProps {
  classId: number;
  className: string;
  onBack: () => void;
...
export function TeacherClassSubjects({
  ...
  const loadSubjects = async () => {
    try {
      ...
      // Load teacher assignments for this class - shows which teachers teach which subjects
      ...
      const teacherAssignments: TeacherAssignment[] = Array.isArray(
        ...
        ? teacherAssignmentsResponse.data
        : (
            teacherAssignmentsResponse.data as unknown as {
